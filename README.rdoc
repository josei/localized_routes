...
After installing the plugin, add this line to app/controllers/application_controller.rb:
  
  include LocalizedRoutes::Controller

The routes can be translated in your locale files like this:
